...
echo "Running DeepSpeed for OpenAI HumanEval benchmark..."
...
if [ "$dataset" == "openai_humaneval" ]; then
    if [ "$modelType" == "8x7B" ]; then
        python benchmarks/baseline/ds.py --model mistralai/Mixtral-8x7B-v0.1 \
            --batch-size 129 --n-token 32 --dataset openai_humaneval
    elif [ "$modelType" == "8x22B" ]; then
        python benchmarks/baseline/ds.py --model mistralai/Mixtral-8x22B-v0.1 \
    ...
    if [ "$modelType" == "8x7B" ]; then
        python benchmarks/baseline/ds.py --model mistralai/Mixtral-8x7B-v0.1 \
            --batch-size 82 --n-token 32 --dataset samsum
    elif [ "$modelType" == "8x22B" ]; then
        python benchmarks/baseline/ds.py --model mistralai/Mixtral-8x22B-v0.1 \
            --batch-size 32 --n-token 32 --dataset samsum
    else
        echo "Unsupported model type. Use '8x7B' or '8x22B'."
        exit 1
    fi
    ...
    if [ "$modelType" == "8x7B" ]; then
        python benchmarks/baseline/ds.py --model mistralai/Mixtral-8x7B-v0.1 \
            --batch-size 64 --n-token 32 --dataset summeval
    elif [ "$modelType" == "8x22B" ]; then
        python benchmarks/baseline/ds.py --model mistralai/Mixtral-8x22B-v0.1 \
    ...
    if [ "$modelType" == "8x7B" ]; then
        python benchmarks/baseline/ds.py --model mistralai/Mixtral-8x7B-v0.1 \
            --batch-size 112 --n-token 32 --dataset ceval_exam
    elif [ "$modelType" == "8x22B" ]; then
        python benchmarks/baseline/ds.py --model mistralai/Mixtral-8x22B-v0.1 \
